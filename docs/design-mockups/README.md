...
3. `planet-flare-3d-gradient-tests.svg`
...
node docs/design-mockups/render-pngs.mjs docs/design-mockups/planet-flare-theme-directions.svg docs/design-mockups/planet-flare-3d-gradient-tests.svg
```
