export const RoundVotingEngineAbi = [
  ...
  {
    "type": "function",
    "name": "getRoundParticipationRateBps",
    "inputs": [
      {
        "name": "contentId",
        "type": "uint256",
  ...
  {
    "type": "function",
    "name": "getRoundStakeWithApprovedFrontend",
    "inputs": [
      {
        "name": "contentId",
        "type": "uint256",
  ...
  {
    "type": "function",
    "name": "isParticipationRewardClaimed",
    "inputs": [
      {
        "name": "contentId",
        "type": "uint256",
