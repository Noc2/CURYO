...
- Use a managed MCP token today. The hosted x402 bounty endpoint has been removed; funding should go directly from a user or agent-controlled wallet into protocol escrow.
