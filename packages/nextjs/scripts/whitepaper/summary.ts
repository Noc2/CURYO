...
export const META = {
  ...
  deck: "Get verified, rate with reputation, and earn USDC for answers AI can verify.",
  author: "AI",
  version: "0.4",
  date: "April 2026",
};
