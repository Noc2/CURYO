...
import { DOCS_AI_ROUTE, GOVERNANCE_ROUTE, RATE_ROUTE } from "~~/constants/routes";
...
export function LandingPageActions() {
  ...
  return (
    <div className="mt-6 flex flex-wrap justify-center gap-3 lg:justify-start">
      ...
      <Link href={DOCS_AI_ROUTE} className={`btn whitespace-nowrap ${styles.cta} ${styles.secondary}`}>
