...
const actionTemplates: readonly GovernanceActionTemplate[] = [
  ...
  },
  {
    ...
    buildArgs: (values, parser) => [
      ...
      parser.string("rankingQuestion", "Ranking question"),
    ],
  ...
  },
  {
    ...
    description: "Create a proposal to approve a registered frontend so it can earn fees.",
    ...
    buildDescription: values => `Approve frontend ${values.frontend || "address"}`,
  },
  {
    id: "frontend-revoke",
    group: "Frontend Registry",
    label: "Revoke frontend",
    mode: "proposal",
    contractName: "FrontendRegistry",
    functionName: "revokeFrontend",
    description: "Create a proposal to revoke a frontend's approval.",
    fields: [{ key: "frontend", label: "Frontend address", type: "address", required: true }],
    buildArgs: (_, parser) => [parser.address("frontend", "Frontend address")],
    buildDescription: values => `Revoke frontend ${values.frontend || "address"}`,
  },
  {
    id: "frontend-slash",
    group: "Frontend Registry",
